...
const AboutEducation = () => {
  ...
  return (
    <motion.div
      className="professional-card p-6 sm:p-8 pb-3 rounded-2xl shadow-xl shadow-black/25 hover:border-cyan-300/30 transition-all duration-300"
    ...
    >
      ...
      <div className="space-y-6">
        {education.map((item, index) => (
          <motion.div 
            key={index} 
            className="relative pl-6 border-l-2 border-cyan-200/25 hover:border-cyan-200/45 transition-colors"
