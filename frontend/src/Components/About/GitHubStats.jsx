...
const GitHubStats = () => {
  ...
  return (
    <motion.div
      className="professional-card p-6 sm:p-8 pt-4 rounded-2xl shadow-xl shadow-slate-300/30 hover:border-slate-300/70 transition-all duration-300 h-full"
      variants={containerVariants}
      whileHover={{ y: -5, transition: { duration: 0.3 } }}
    >
      <h3 className="text-xl sm:text-2xl font-bold mb-6 text-slate-900 flex items-center">
        <span className="mr-3 p-2 rounded-lg bg-slate-100 border border-slate-300/60">
      ...
      <div className="space-y-4">
        <motion.div variants={itemVariants} className="flex flex-col items-center space-y-4">
          ...
          <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-3">
            {/* Total Contributions */}
            <motion.div 
              className="bg-white/95 backdrop-blur-sm p-4 rounded-xl border border-slate-300/70 hover:border-slate-400/70 transition-all"
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-xl md:text-2xl font-bold text-slate-900">{githubData.totalContributions}</p>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-xl md:text-2xl font-bold text-slate-900">{githubData.totalActiveDays}</p>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-xl md:text-2xl font-bold text-slate-900">{githubData.maxStreak}</p>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-xl md:text-2xl font-bold text-slate-900">{githubData.currentStreak}</p>
          ...
          <div className="w-full rounded-xl shadow-lg border border-slate-300/70 bg-white/95 backdrop-blur-sm p-4 md:p-6 overflow-hidden">
            <h4 className="text-base md:text-lg font-semibold text-slate-800 mb-3 flex items-center">
          ...
          <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xl md:text-2xl font-bold text-slate-900">{githubData.stats.stars}</p>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xl md:text-2xl font-bold text-slate-900">{githubData.stats.repositories}</p>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xl md:text-2xl font-bold text-slate-900">{githubData.stats.prs}</p>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xl md:text-2xl font-bold text-slate-900">{githubData.stats.issues}</p>
        ...
        <motion.div variants={itemVariants} className="flex justify-center mt-4">
          <a 
            ...
            className="px-5 py-2.5 bg-slate-900 hover:bg-slate-800 rounded-full text-white text-sm font-medium flex items-center transition-all shadow-lg hover:shadow-slate-400/40 hover:scale-105"
          >
