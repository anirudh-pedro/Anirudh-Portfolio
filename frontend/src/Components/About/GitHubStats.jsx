  ...
  return (
    ...
    >
      <h3 className="text-xl sm:text-2xl font-bold mb-6 text-purple-400 flex items-center">
        <span className="mr-3 p-2 rounded-lg bg-gradient-to-br from-purple-500/20 to-purple-600/20">
      ...
      <div className="space-y-4">
        <motion.div variants={itemVariants} className="flex flex-col items-center space-y-4">
          {/* GitHub Stats Card */}
          <div className="w-full overflow-hidden rounded-xl shadow-lg border border-purple-500/10 transform transition-transform hover:scale-[1.02] duration-300">
            <img 
          ...
          {/* GitHub Streak Stats */}
          <div className="w-full overflow-hidden rounded-xl shadow-lg border border-purple-500/10 transform transition-transform hover:scale-[1.01] duration-300">
            <img 
