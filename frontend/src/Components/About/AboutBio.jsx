  ...
  return (
    ...
    >
      ...
      <div className="space-y-4 text-gray-300 leading-relaxed">
        <p>
          Hello! I'm <span className="font-semibold text-purple-400">Anirudh T</span>, a passionate full-stack developer with a focus on creating efficient, 
        ...
        <p>
          I specialize in modern web technologies, particularly the <span className="font-semibold text-purple-400">MERN stack</span> (MongoDB, Express, React, Node.js). 
