...
const LeetCodeStats = () => {
  ...
  return (
    <motion.div
      className="bg-gradient-to-br from-black/60 to-black/40 backdrop-blur-xl p-6 sm:p-8 rounded-2xl border border-orange-500/20 shadow-xl shadow-orange-500/10 hover:border-orange-400/30 transition-all duration-300 h-full"
      variants={containerVariants}
      whileHover={{ y: -5, transition: { duration: 0.3 } }}
    >
      <h3 className="text-xl sm:text-2xl font-bold mb-6 text-orange-400 flex items-center">
        <span className="mr-3 p-2 rounded-lg bg-orange-500/20">
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="w-full overflow-hidden rounded-xl shadow-lg border border-orange-500/10">
            <img 
        ...
        >
          <a 
            ...
            className="px-5 py-2.5 bg-orange-600 hover:bg-orange-700 rounded-full text-white text-sm font-medium flex items-center transition-all shadow-lg hover:shadow-orange-500/50 hover:scale-105"
          >
