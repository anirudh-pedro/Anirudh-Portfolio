...
const LeetCodeStats = () => {
  ...
  return (
    <motion.div
      className="bg-black/20 backdrop-blur-md p-8 rounded-2xl border border-white/10 mt-2"
      variants={containerVariants}
    >
      <h3 className="text-2xl font-bold mb-6 text-white flex items-center">
        <span className="mr-3 p-2 rounded-full bg-orange-500/20">
      ...
      <div className="space-y-6">
        ...
        >
          <a 
            ...
            className="px-5 py-2 bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 rounded-full text-white text-sm font-medium flex items-center transition-colors"
          >
