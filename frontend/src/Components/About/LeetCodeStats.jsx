...
const LeetCodeStats = () => {
  ...
  return (
    <motion.div
      className="professional-card p-4 sm:p-5 rounded-2xl shadow-xl shadow-slate-300/30 hover:border-orange-300/60 transition-all duration-300"
      variants={containerVariants}
      whileHover={{ y: -5, transition: { duration: 0.3 } }}
    >
      <h3 className="text-lg sm:text-xl font-bold mb-3 text-orange-600 flex items-center">
        <span className="mr-2 p-1.5 rounded-lg bg-orange-500/20">
      ...
      <div className="space-y-3">
        ...
        >
          ...
          <div className="w-full overflow-hidden rounded-lg shadow-lg border border-slate-300/70 bg-white">
            <img 
              src={`https://leetcard.jacoblin.cool/${leetcodeUsername}?theme=light&font=Nunito&ext=heatmap`}
        ...
        >
          <a 
            ...
            className="px-5 py-2 bg-orange-600 hover:bg-orange-700 rounded-full text-white text-sm font-medium flex items-center transition-all shadow-lg hover:shadow-orange-500/50 hover:scale-105"
          >
