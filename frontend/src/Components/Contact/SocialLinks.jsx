      ...
      >
        {socialLinks.map(social => (
          <motion.a
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-gray-800/50 hover:bg-gray-700/50 rounded-lg transition-colors border border-gray-700/50 hover:border-blue-500/30"
